...
template<size_t MASK, size_t ITERATIONS, size_t MEM, bool SOFT_AES, bool PREFETCH>
void cryptonight_six_hash(const void* input, size_t len, void* output, cryptonight_ctx** ctx)
{
...
// This most lovely creation will do 7 cn hashes at a time.
template<size_t MASK, size_t ITERATIONS, size_t MEM, bool SOFT_AES, bool PREFETCH>
void cryptonight_seven_hash(const void* input, size_t len, void* output, cryptonight_ctx** ctx)
{
...
template<size_t MASK, size_t ITERATIONS, size_t MEM, bool SOFT_AES, bool PREFETCH>
void cryptonight_eight_hash(const void* input, size_t len, void* output, cryptonight_ctx** ctx)
{
	...
	{
		uint64_t idx0, idx1, idx2, idx3, idx4, hi, lo;
		uint64_t idx5, idx6, idx7;
		__m128i *ptr0, *ptr1, *ptr2, *ptr3, *ptr4;
		__m128i *ptr5, *ptr6, *ptr7;
...
// This most lovely creation will do 9 cn hashes at a time.
template<size_t MASK, size_t ITERATIONS, size_t MEM, bool SOFT_AES, bool PREFETCH>
void cryptonight_nine_hash(const void* input, size_t len, void* output, cryptonight_ctx** ctx)
{
	...
	{
		uint64_t idx0, idx1, idx2, idx3, idx4, hi, lo;
		uint64_t idx5, idx6, idx7, idx8;
		__m128i *ptr0, *ptr1, *ptr2, *ptr3, *ptr4;
		__m128i *ptr5, *ptr6, *ptr7, *ptr8;
...
void cryptonight_ten_hash(const void* input, size_t len, void* output, cryptonight_ctx** ctx)
{
	...
	{
		uint64_t idx0, idx1, idx2, idx3, idx4, hi, lo;
		uint64_t idx5, idx6, idx7, idx8, idx9;
		__m128i *ptr0, *ptr1, *ptr2, *ptr3, *ptr4;
		__m128i *ptr5, *ptr6, *ptr7, *ptr8, *ptr9;
